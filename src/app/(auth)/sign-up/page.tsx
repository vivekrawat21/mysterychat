...
const page = () => {
  ...
  const debounced = useDebounceCallback(setUsername, 300); //when we fire a request it will go in debouce way not immediately
  ...
  const onSubmit = async (data: z.infer<typeof signUpSchema>) => {
    ...
    try {
      ...
      toast({
        ...
        description: errorMessage || "Error in signing up",
        variant: "destructive",
      });
      setIsSubmitting(false);
    }
